...
const getProductsFromOrder_handler_1 = __importDefault(require("./../handelers/getProductsFromOrder.handler"));
getProductsFromOrder_handler_1.default;
...
function fetchAllRoutes(app) {
    ...
    (0, getProductsFromOrder_handler_1.default)(app);
}
